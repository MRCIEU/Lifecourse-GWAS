...
${d}/bin/azcopy copy "${results_dir}/${cohort_name}_${step}.tar.gz" "https://lcgwassftp.blob.core.windows.net/analysts/${sftp_username}/${cohort_name}_${step}.tar.gz?${sas_token}"

${d}/bin/azcopy copy "${results_dir}/${cohort_name}_${step}.tar.gz.md5" "https://lcgwassftp.blob.core.windows.net/analysts/${sftp_username}/${cohort_name}_${step}.tar.gz.md5?${sas_token}"
